...
- `PRODUCT`: 제품 정보 관리. 원본 설계서의 책임을 가진다.
...
| `code` | VARCHAR(100) | - | True | - | False | - | 제품 코드 | - |
| `name` | VARCHAR(200) | - | - | - | True | - | 제품명 | - |
| `info` | TEXT | - | - | - | - | - | 제품 정보 | - |
| `remarks` | TEXT | - | - | - | - | - | 특기사항 | 해당 제품 공통으로 신경써야 할 내용 |
| `note` | TEXT | - | - | - | True | - | 비고 | 비고 |
| `uuid` | UUID | - | True | - | True | gen_random_uuid() | UUID | 제품 UUID |
