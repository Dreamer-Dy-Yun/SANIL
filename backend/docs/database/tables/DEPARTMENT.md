...
- `DEPARTMENT`: 부서관리. 원본 설계서의 책임을 가진다.
...
| `parent_uuid` | UUID | - | COMPOSITE | - | True | - | 상급부서 UUID | 최상위 부서는 NULL |
| `name` | TEXT | - | COMPOSITE | - | - | - | 부서명 | - |
| `sort_order` | NUMERIC(20,10) | - | - | - | - | - | 정렬 순서 | 부서 정렬 순서. 소숫점 허용 |
...
- 기본키: `id`
- Unique: `parent_uuid`=COMPOSITE, `name`=COMPOSITE, `uuid`=True
- Foreign Key: -
